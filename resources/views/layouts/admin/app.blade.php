				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							<!--begin::Menu Nav-->
							<ul class="menu-nav" id="adminDashboardHeader">
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="/admin/access-analyze" class="menu-link menu-toggle">
										...
										<span class="menu-text">アクセス解析</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="/admin/promotion-printing" class="menu-link menu-toggle">
										...
										<span class="menu-text">宣伝ちらし印刷</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
										...
										<div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded" style="background-image: url(assets/media/misc/bg-1.jpg)">
											...
											<div class="">
												...
												<form method="POST" action="{{ route('logout') }}">
													...
													<x-dropdown-link :href="route('logout')" class="btn btn-success btn-md font-weight-bold font-size-md mt-2"
        ...
        <script>
			...
			$(document).ready(function() {
				...
				switch (secondPathSegment) {
					// case "admin":
					// 	$("#adminDashboardHeader").children().eq(0).addClass("menu-item-active");
					// 	break;
					case "access-analyze":
						$("#adminDashboardHeader").children().eq(0).addClass("menu-item-active");
						break;
					case "promotion-printing":
						$("#adminDashboardHeader").children().eq(1).addClass("menu-item-active");
						break;
					case "user-management":
						$("#adminDashboardHeader").children().eq(2).addClass("menu-item-active");
						break;
					default:
						$("#adminDashboardHeader").children().find("menu-item").removeClass("menu-item-active");
				}
			});
